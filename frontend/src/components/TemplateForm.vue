...
<template>
  <div class="flex flex-col gap-7">
    ...
    <CodeEditor :modelValue="modelValue.html_body" @update:modelValue="$emit('update:modelValue', { ...modelValue, html_body: $event })" language="html" :min-height="minEditorHeight ?? '200px'" label="HTML Body" />
